...
def args_parse():
    ...
    parser.add_argument("--experiment_id", default='train_5', type=str)
    ...
    parser.add_argument('--max_step_per_epi', default=1, type=int)
    parser.add_argument('--meta-step-size', help='meta-training step size', default=1.0, type=float)
    parser.add_argument('--meta-final', help='meta-training step size by the end', default=0.01, type=float)
    ...
    for episode in range(1, args.max_episodes):
        ...
        if episode % 100 == 0:
            ...
            model.scalars("sr", {'step': np.mean(solved_step),
                                 'episode': np.mean(solved_epi),
                                 'var': model.var}, episode)
